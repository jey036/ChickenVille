...
public class HerdSimCore:MonoBehaviour{
	...
	///GROUND
	public float _groundCheckInterval = 0.5f;	//How often to check where the ground is
	...
	public Vector3 _ground;					//Position of last ground position
	...
	public float _fakeGravity = 1.0f;			//How fast this will move towards the ground. This works on both up and down directions smoothly.
	...
	public float _randomDeath = .001f;				//The chance this will die randomly (aprox check every second)
